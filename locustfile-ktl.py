...
def on_locust_init(environment, **_kwargs):
    listeners.Timescale(env=environment, testplan="taurus_ktl_listener_ex", target_env="myTestEnv")
 #  TimescaleListener(env=environment, testplan="taurus_ktl_listener_ex", target_env="myTestEnv") - OLD