...
def on_locust_init(environment, **_kwargs):
    listeners.Timescale(env=environment, testplan="taurus_cah_listener_ex", target_env="myTestEnv")
 #   TimescaleListener(env=environment, testplan="taurus_cah_listener_ex", target_env="myTestEnv")  - OLD